    ...
    <div class="main-content">
        <div class="content">
            ...
            <section id="balance" class="section">
                <h2>Balance Page</h2>
                <p>Total Income: <?php echo number_format($totalIncome, 2); ?> Tk</p>
                <p>Total Expense: <?php echo number_format($totalExpense, 2); ?> Tk</p>
                <p><strong>Current Balance: <?php echo number_format($balance, 2); ?> Tk</strong></p>
            </section>
